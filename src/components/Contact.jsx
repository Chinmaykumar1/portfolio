...
export default function Contact() {
  return (
    <section id="contact" className="contact-section">
      <RevealDiv>
        <h2>Let&rsquo;s build<br />something <em>great</em></h2>
      </RevealDiv>
      <RevealDiv>
        <p>Open to exciting opportunities and collaborations. Whether you have a project in mind or just want to connect &mdash; I&rsquo;d love to hear from you.</p>
      </RevealDiv>
      <RevealDiv>
        <div className="contact-links">
          <a href="mailto:ichinmaykr@gmail.com" className="contact-chip">
            ...
            ichinmaykr@gmail.com
          </a>
          <a href="https://www.linkedin.com/in/chinmay-kumar-a75b9b1b4/" target="_blank" rel="noopener noreferrer" className="contact-chip">
          ...
          <a href="https://github.com/Chinmaykumar1" target="_blank" rel="noopener noreferrer" className="contact-chip">
          ...
          <a href="tel:+919521024536" className="contact-chip">
